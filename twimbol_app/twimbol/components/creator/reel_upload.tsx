...
const CreateReel = () => {
        ...
        try {
            ...
            if (!result.canceled) {
                ...
                if (fileInfo.size > 40 * 1024 * 1024) {
                    Alert.alert(
                        'File too large',
                        'The selected video is larger than 40MB. Please choose a smaller video.'
                    );
                    return;
                }
    ...
    const uploadVideo = async () => {
        ...
        try {
            ...
            // Log API endpoint
            const apiEndpoint = `${TWIMBOL_API_CONFIG.BASE_URL}/create/reel/`;
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.header}>
                <Text style={styles.headerText}>Upload Reel</Text>
            </View>
                        ...
                        {reelFile ? (
                            ...
                            <View style={styles.uploadContent}>
                                <View style={styles.uploadPlaceholder}>
                                    ...
                                    <Text style={styles.uploadText}>Click to upload reel</Text>
                                </View>
                            </View>
                        )}
                    </TouchableOpacity>
